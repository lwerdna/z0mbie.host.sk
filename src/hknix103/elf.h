...
typedef struct elf32_sym{
  Elf32_Word    st_name;        // 00 01 02 03
  Elf32_Addr    st_value;       // 04 05 06 07
  Elf32_Word    st_size;        // 08 09 0A 0B
  unsigned char st_info;        // 0C
  unsigned char st_other;       // 0D
...
typedef struct elf32_hdr{
  unsigned char e_ident[EI_NIDENT];              // 00 .. 0F
  Elf32_Half    e_type;                          // 10 11
  Elf32_Half    e_machine;                       // 12 13
  Elf32_Word    e_version;                       // 14 15 16 17
  Elf32_Addr    e_entry;  /* Entry point */      // 18 19 1A 1B
  Elf32_Off     e_phoff;                         // 1C 1D 1E 1F
  Elf32_Off     e_shoff;                         // 20 21 22 23
  Elf32_Word    e_flags;                         // 24 25 26 27
...
typedef struct {
  Elf32_Word    sh_name;                // 00 01 02 03
  Elf32_Word    sh_type;                // 04 05 06 07
  Elf32_Word    sh_flags;               // 08 09 0A 0B
  Elf32_Addr    sh_addr;                // 0C 0D 0E 0F
  Elf32_Off     sh_offset;              // 10 11 12 13
  Elf32_Word    sh_size;                // 14 15 16 17
  Elf32_Word    sh_link;                // 18 19 1A 1B
  Elf32_Word    sh_info;                // 1C 1D 1E 1F
  Elf32_Word    sh_addralign;           // 20 21 22 23
  Elf32_Word    sh_entsize;             // 24 25 26 27
} Elf32_Shdr;
